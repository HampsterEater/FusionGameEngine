...
namespace BinaryPhoenix.Fusion.Runtime.Scripting
{
    ...
    public class ScriptExportFunction
    {
        ...
        private static Hashtable _functionHashTable = new Hashtable();
        ...
        /// </summary>
        public static Hashtable FunctionHashTable
        {
            get { return _functionHashTable; }
            set { _functionHashTable = value; }
        }
    ...
    public abstract class RuntimeObject
    {
        ...
        public virtual RuntimeObject Clone()
        {
            return null;
        }
    ...
    public abstract class NativeObject : RuntimeObject
    {
        ...
        /// </summary>
        /// <returns>Clone of this object.</returns>
        public override RuntimeObject Clone()
        {
            NativeObject obj = (NativeObject)Activator.CreateInstance(this.GetType());
            obj._nativeObject = _nativeObject;
//            obj._referenceCount = _referenceCount;
            obj._collectable = _collectable;
    ...
    /// <summary>
    ///     Stores a union to be used by a runtime value.
    /// </summary>
    [StructLayout(LayoutKind.Explicit)]
    public struct RuntimeValueUnion
    {
        [FieldOffset(0)] public bool BooleanLiteral;
        [FieldOffset(0)] public byte ByteLiteral;
        [FieldOffset(0)] public int IntegerLiteral;
        [FieldOffset(0)] public short ShortLiteral;
        [FieldOffset(0)] public float FloatLiteral;
        [FieldOffset(0)] public double DoubleLiteral;
        [FieldOffset(0)] public long LongLiteral;
    }
	...
	public class RuntimeValue
	{
        ...
        private string _stringLiteralValue = "";
        private RuntimeValueUnion _values;
		...
		{
            get { return _stringLiteralValue; }
            set { _stringLiteralValue = value; }
		}
		...
		{
            get { return _values.BooleanLiteral; }
            set { _values.BooleanLiteral = value; }
		}
		...
		{
            get { return _values.ByteLiteral; }
            set { _values.ByteLiteral = value; }
		}
		...
		{
            get { return _values.IntegerLiteral; }
            set { _values.IntegerLiteral = value; }
		}
		...
		{
            get { return _values.ShortLiteral; }
            set { _values.ShortLiteral = value; }
		}
		...
		{
            get { return _values.FloatLiteral; }
            set { _values.FloatLiteral = value; if (float.IsNaN(_values.FloatLiteral)) _values.FloatLiteral = 0.0f; }
		}
		...
		{
            get { return _values.DoubleLiteral; }
            set { _values.DoubleLiteral = value; }
		}
		...
		{
            get { return _values.LongLiteral; }
            set { _values.LongLiteral = value; }
		}
		...
		public override string ToString()
		{
			...
			switch (_valueType)
			{
                case RuntimeValueType.BooleanLiteral: text += _values.BooleanLiteral; break;
                case RuntimeValueType.ByteLiteral: text += _values.ByteLiteral; break;
                ...
                case RuntimeValueType.DoubleLiteral: text += _values.DoubleLiteral; break;
                case RuntimeValueType.FloatLiteral: text += _values.FloatLiteral; break;
                ...
                case RuntimeValueType.IntegerLiteral: text += _values.IntegerLiteral; break;
                case RuntimeValueType.LongLiteral: text += _values.LongLiteral; break;
                ...
                case RuntimeValueType.ShortLiteral: text += _values.ShortLiteral; break;
                case RuntimeValueType.StringLiteral: text += _stringLiteralValue == null ? "" : _stringLiteralValue; break;
		...
		public bool IsNull()
		{
			switch (_valueType)
			{
                ...
                case RuntimeValueType.BooleanLiteral: if (_values.BooleanLiteral == false) return true; break;
                case RuntimeValueType.ByteLiteral: if (_values.ByteLiteral == 0) return true; break;
                case RuntimeValueType.DoubleLiteral: if (_values.DoubleLiteral == 0) return true; break;
                case RuntimeValueType.FloatLiteral: if (_values.FloatLiteral == 0) return true; break;
                case RuntimeValueType.IntegerLiteral: if (_values.IntegerLiteral == 0) return true; break;
                case RuntimeValueType.LongLiteral: if (_values.LongLiteral == 0) return true; break;
                case RuntimeValueType.ShortLiteral: if (_values.ShortLiteral == 0) return true; break;
                case RuntimeValueType.StringLiteral: if (_stringLiteralValue == "") return true; break;
			}
			return false;
		}
	...
	public sealed class VirtualMachine
	{
        ...
        private static VirtualMachine _globalInstance = new VirtualMachine(false);

		#endregion
		#region Properties

        /// <summary>
        ///		Gets or sets the script's virtual machine that this entity's logic process is running off.
        /// </summary>
        public static VirtualMachine GlobalInstance
        {
        ...
        /// <summary>
        ///     Removes any references to the given object in all processes held by this virutal machine.
        /// </summary>
        /// <param name="obj">Object to remove references about.</param>
        public void RemoveReferences(object obj)
        {
            foreach (ScriptProcess process in _processes)
                process.RemoveReferences(obj);
        }
	...
	public sealed class ScriptProcess
	{
		...
		private RuntimeValue[] _memoryHeap = new RuntimeValue[256];
        private RuntimeObject[] _objectHeap = new RuntimeObject[64];
        ...
        private Hashtable _memberFunctionHashTable = new Hashtable();
        ...
        /// <summary>
        ///     Gets or sets the flags this script was compiled with.
        /// </summary>
        public CompileFlags CompileFlags
        {
            get { return _compileFlags; }
            set { _compileFlags = value; }
        }
        ...
        /// <summary>
        ///     Gets or sets the member-function hash table.
        /// </summary>
        public Hashtable MemberFunctionHashTable
        {
            get { return _memberFunctionHashTable; }
            set { _memberFunctionHashTable = value; }
        }
        ...
        /// <summary>
        ///     Checks if garbage needs to be collected.
        /// </summary>
		...
		public void CollectGarbage()
		{
            ...
            for (int i = 1; i < _objectHeap.Length; i++)
            {
              ...
              //  System.Console.WriteLine(_objectHeap[i].ToString() + " Ref:" + _objectHeap[i].ReferenceCount);
                if (_objectHeap[i].ReferenceCount <= 0 && _objectHeap[i].Collectable == true)
                {
                    collectedObjects++;
                   // System.Console.WriteLine("Collected object " + i + " (REFS: " + _objectHeap[i].ReferenceCount + ").");
                    _objectHeap[i].Deallocate();
                    _objectHeap[i] = null;
                }
            }
            ...
            for (int i = 1; i < _memoryHeap.Length; i++)
            {
                ...
                {
                    collectedMemSize++;
                    //System.Console.WriteLine("Collected memory " + i + " (REFS: " + _memoryHeap[i].ReferenceCount + ").");
                    DeallocateHeap(i + 1); // FIX
                }
            }

//            if (collectedObjects > 0 || collectedMemSize > 0)
//                System.Console.WriteLine("OBJ:"+collectedObjects+" MEM:"+collectedMemSize);
        ...
        /// <summary>
        ///     Disposes of all resources held by this script/
        /// </summary>
        public void Dispose()
        {
            // Dettach process.
            _virtualMachine.DetachProcess(this);
            ...
            // Destroy all references this script holds.
            for (int i = 0; i < _objectHeap.Length; i++)
                _objectHeap[i] = null;
            for (int i = 0; i < _memoryHeap.Length; i++)
                _memoryHeap[i] = null;
        /*
            _objectHeap = null;
            _memoryHeap = null;
            _memberFunctionHashTable.Clear();
	...
	public sealed class ScriptThread
	{
        ...
        {
            Debug.DebugLogger.WriteLog("Virtual Machine (" + _process.Instructions[_instructionPointer].File + ":" + _process.Instructions[_instructionPointer].Line + "," + _process.Instructions[_instructionPointer].Offset+ ") reported the following error;\n\t" + message, LogAlertLevel.Error); 
            ShowDebugger();
        }
        ...
        {
            if ((_process.CompileFlags & CompileFlags.Debug) != 0)
            {
		...
		{
            if (_process.MemoryHeap[value - 1] == null) return -1;
